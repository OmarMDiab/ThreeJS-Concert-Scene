...
async function init() {
    ...
    try {
        ...
        // Wait for async initializations (e.g., loading models)
        const tasks = [
            initIsland(),
            initWelcomeModel(),
            initConcert(),
            ...
            initSkeleton(),
            initYacht(),
            initClouds() // Assuming `initClouds` uses a Promise or can be adapted
        ];
        ...
        loadingScreen.innerHTML = "An error occurred. Please reload the page.";
    }
}
...
function initBox() {
    ...
    box1.position.set(-200, 200, 0); // Set position to one corner of the island
    scene.add(box1);

    // // Create the second box
    box2 = new THREE.Mesh(geometry, material);
    box2.position.set(-200, 200,0); // Set position to the opposite corner of the island
    scene.add(box2);
}
        ...
        loader.load(
            ...
            (gltf) => {
                try {
                    ...
                    resolve(); // Resolve the promise when the concert model is added to the scene
                } catch (error) {
                    reject(`Error processing concert model: ${error}`);
                }
            },
            undefined,
            (error) => {
                reject(`Error loading concert model: ${error}`);
            }
        );
    });
}
    ...
    return new Promise((resolve, reject) => {
        ...
        loader.load(
            ...
            (gltf) => {
                ...
                resolve(); // Resolve the promise once the lasers are added
            },
            undefined,
            (error) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        loader.load(
            ...
            (gltf) => {
                ...
                resolve(); // Resolve the promise when the audience is added
            },
            undefined,
            (error) => {
...
function initVideo() {
    return new Promise((resolve, reject) => {
        ...
        loader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', function (font) {
            ...
            console.error('Error loading font for buttons:', error);
            ...
            if (intersects.length > 0) {
                if (intersects[0].object === buttonMesh) {
                    ...
                    video.play().catch((error) => {
                        ...
                        reject(error); // Reject the promise if video fails to play
                    });
                    soundEffect.play().catch((error) => {
                        console.error('Error playing sound effect:', error);
                        reject(error); // Reject the promise if sound effect fails
                    });
        ...
        resolve(); // Resolve the promise when the video setup is complete
    });
}
        ...
        loader.load(
            ...
            (gltf) => {
                try {
                    ...
                    resolve(); // Resolve the promise when the island is added to the scene
                } catch (error) {
                    reject(`Error processing Easter Island head model: ${error}`);
                }
            },
            undefined,
            (error) => {
                reject(`Error loading Easter Island head model: ${error}`);
            }
        );
    });
}
    ...
    return new Promise((resolve, reject) => {
        ...
        loader.load('public/clouds/scene.gltf', function (gltf) {
            try {
                ...
                resolve(); // Resolve the promise when the clouds are added to the scene
            } catch (error) {
                reject(`Error processing clouds model: ${error}`);
            }
        }, undefined, function (error) {
            reject(`Error loading clouds model: ${error}`);
        });
    });
}
        ...
        loader.load(
            ...
            (gltf) => {
                try {
                    ...
                    resolve(); // Resolve the promise when the lighthouse is added to the scene
                } catch (error) {
                    reject(`Error processing lighthouse model: ${error}`);
                }
            },
            undefined,
            (error) => {
                reject(`Error loading lighthouse model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    scene.add(house);
                    resolve(); // Resolve the promise when the house is added to the scene
                } catch (error) {
                    reject(`Error processing house model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading house model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    resolve(); // Resolve the promise when the skeleton is added to the scene
                } catch (error) {
                    reject(`Error processing skeleton model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading skeleton model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    scene.add(yacht);
                    resolve(); // Resolve the promise when the yacht is added to the scene
                } catch (error) {
                    reject(`Error processing yacht model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading yacht model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    scene.add(ship);
                    resolve(); // Resolve the promise when the ship is added to the scene
                } catch (error) {
                    reject(`Error processing classic ship model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading classic ship model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    resolve(); // Resolve the promise when the whale is added to the scene
                } catch (error) {
                    reject(`Error processing whale model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading whale model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    resolve(); // Resolve the promise when the phoenix is added to the scene
                } catch (error) {
                    reject(`Error processing phoenix model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading phoenix model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    resolve(); // Resolve the promise when the bird is added to the scene
                } catch (error) {
                    reject(`Error processing bird model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading bird model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    scene.add(island);
                    resolve(); // Resolve the promise when the island is added
                } catch (error) {
                    reject(`Error processing island model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading island model: ${error}`);
            }
        );
    });
}
        ...
        loader.load(
            ...
            function (gltf) {
                try {
                    ...
                    resolve(); // Resolve the promise when the welcome model is added
                } catch (error) {
                    reject(`Error processing welcome model: ${error}`);
                }
            },
            undefined,
            function (error) {
                reject(`Error loading welcome model: ${error}`);
            }
        );
    });
}
